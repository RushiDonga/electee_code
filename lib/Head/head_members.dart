...
class HeadTotalMembers extends StatefulWidget {
  @override
  _HeadTotalMembersState createState() => _HeadTotalMembersState();

  HeadTotalMembers({this.code});

  final String code;
}

class _HeadTotalMembersState extends State<HeadTotalMembers> {
