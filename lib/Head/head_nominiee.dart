...
class HeadTotalNominiee extends StatefulWidget {
  @override
  _HeadTotalNominieeState createState() => _HeadTotalNominieeState();

  HeadTotalNominiee({this.code});

  final String code;
}

class _HeadTotalNominieeState extends State<HeadTotalNominiee> {
