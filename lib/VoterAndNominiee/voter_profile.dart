...
class VoterNdNominieeProfile extends StatefulWidget {
  @override
  _VoterNdNominieeProfileState createState() => _VoterNdNominieeProfileState();

  VoterNdNominieeProfile({this.name,@required this.code, this.userID, this.history});
...
class _VoterNdNominieeProfileState extends State<VoterNdNominieeProfile> {
    ...
    getStatus.onValue.listen((event) {
      setState(() {
        ...
        if(status == "false"){
          ...
          Toast.show("Election has been Started", context, duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
          ...
          Toast.show("Election is now Over", context, duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
  ...
  void checkWinnerSetting(){
    ...
    getWinnerSetting.once().then((DataSnapshot snapshot){
      setState(() {
        ...
        if(winnerSetting == "VOTERS" || winnerSetting == "ALL MEMBERS"){
  ...
  void initState(){
    ...
    getElectionName.once().then((DataSnapshot snapshot){
      ...
      // register in History
      DatabaseReference history = FirebaseDatabase.instance.reference().child("History").child(userID).child("VoterHistory");
                                          ...
                                          GestureDetector(
                                            onTap: (){
                                              if(totalVoters != 0){
                                                ...
                                                Toast.show("No Voters have Joined", context, duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                                              }
                                            },
                                          ...
                                          GestureDetector(
                                            onTap: (){
                                              if(totalNominie != 0){
                                                ...
                                                Toast.show("No Nominiee have Joined", context, duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                                              }
                                            },
                                            child: NamePlusNumber(
                                              name: "NOMINIEE",
                    ...
                    ButtonBar(
                      children: <Widget>[
                          ...
                          onPressed: (){
                            if(status == "true"){
                              if(totalNominie > 0){
                                ...
                                Toast.show("No Nominiee Available", context, duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                              }
                            }else if(status == "done"){
                              showDialogue("Excited humm..!", "You can now check the Winner in the Winner Section at the Bottom", "Okay");
                        ...
                        RaisedButton(
                          ...
                          onPressed: (){
                            if(status == "true"){
                              showDialogue("Hey $name", "Make Sure you vote before the Election is Stopped", "Okay");
                            }
                          },
                          child: Text(
                            "No..!",
                              ...
                              RaisedButton(
                                ...
                                onPressed: (){
                                  if(totalVoted != 0){
                                    ...
                                    Toast.show("No on has Voted yet", context, duration: Toast.LENGTH_LONG, gravity: Toast.BOTTOM);
                                  }
                                },
                                child: Text(
                                  "View",
